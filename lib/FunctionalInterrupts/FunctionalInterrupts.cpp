...
static const A_Function *functions[EXTERNAL_NUM_INTERRUPTS] = {
...
void attachFunctionalInterrupt(uint8_t interruptNum, const A_Function *function,
  ...
  if (interruptNum < EXTERNAL_NUM_INTERRUPTS) {
    ...
    switch (interruptNum) {
      ...
      // 1280/2560 and the 32U4.  Since avrlib defines registers PCMSK1 and
      // PCMSK2 that aren't even present on the 32U4 this is the only way to
...
#define IMPLEMENT_FUNCTIONAL_ISR(vect, interrupt)                              \
  ISR(vect) { (*FunctionalInterrupts::functions[interrupt])(); }

#if defined(__AVR_ATmega32U4__)

IMPLEMENT_FUNCTIONAL_ISR(INT0_vect, EXTERNAL_INT_0)
IMPLEMENT_FUNCTIONAL_ISR(INT1_vect, EXTERNAL_INT_1)
IMPLEMENT_FUNCTIONAL_ISR(INT2_vect, EXTERNAL_INT_2)
IMPLEMENT_FUNCTIONAL_ISR(INT3_vect, EXTERNAL_INT_3)
IMPLEMENT_FUNCTIONAL_ISR(INT6_vect, EXTERNAL_INT_4)
...
IMPLEMENT_FUNCTIONAL_ISR(INT2_vect, EXTERNAL_INT_2)
IMPLEMENT_FUNCTIONAL_ISR(INT3_vect, EXTERNAL_INT_3)
IMPLEMENT_FUNCTIONAL_ISR(INT4_vect, EXTERNAL_INT_4)
IMPLEMENT_FUNCTIONAL_ISR(INT5_vect, EXTERNAL_INT_5)
